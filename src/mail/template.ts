...
<link href="https://fonts.googleapis.com/css2?family=Bebas+Neue:wght@400" rel="stylesheet" type="text/css"/><!--<![endif]-->
<style>
		* {
		...
		@media (max-width:700px) {
			...
			.row-2 .column-1 .block-1.menu_block label .menu-trigger .menu-label {
				text-align: center !important;
			}
		}

		#memu-r8c0m2:checked~.menu-links {
			background-color: #000000 !important;
		}

		#memu-r8c0m2:checked~.menu-links a,
		#memu-r8c0m2:checked~.menu-links span {
			color: #ffffff !important;
		}
	</style><!--[if mso ]><style>sup, sub { font-size: 100% !important; } sup { mso-text-raise:10% } sub { mso-text-raise:-10% }</style> <![endif]-->
</head>
<body class="body" style="background-color: #b48766; margin: 0; padding: 0; -webkit-text-size-adjust: none; text-size-adjust: none;">
<table border="0" cellpadding="0" cellspacing="0" class="nl-container" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #b48766;" width="100%">
<tbody>
<tr>
<td>
...
<tr>
<td class="pad">
<h1 style="margin: 0; color: #331014; direction: ltr; font-family: 'Bebas Neue', Arial, Helvetica, sans-serif; font-size: 38px; font-weight: 800; letter-spacing: normal; line-height: 120%; text-align: center; margin-top: 0; margin-bottom: 0; mso-line-height-alt: 45.6px;"><span class="tinyMce-placeholder" style="word-break: break-word;">bzz váhy</span></h1>
</td>
</tr>
</table>
</td>
...
<div style="max-width: 226.667px;"><img alt="Company Logo" height="auto" src="${logo}" style="display: block; height: auto; border: 0; width: 100%;" title="Company Logo" width="226.667"/></div>
</div>
</td>
</tr>
</table>
...
<td class="pad">
<div align="center" class="alignment" style="line-height:10px">
<div class="fullWidth" style="max-width: 374px;"><img alt="Resetting Password" height="auto" src="${banner}" style="display: block; height: auto; border: 0; width: 100%;" title="Resetting Password" width="374"/></div>
</div>
</td>
</tr>
</table>
...
<h1 style="margin: 0; color: #000000; direction: ltr; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; font-size: 27px; font-weight: 700; letter-spacing: normal; line-height: 120%; text-align: center; margin-top: 0; margin-bottom: 0; mso-line-height-alt: 32.4px;"><strong>${title}</strong></h1>
</td>
</tr>
</table>
</td>
...
<v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="www.example.com" style="height:44px;width:158px;v-text-anchor:middle;" arcsize="10%" strokeweight="0.75pt" strokecolor="#101" fillcolor="#101">
<w:anchorlock/>
